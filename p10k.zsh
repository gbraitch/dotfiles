# Generated by Powerlevel10k configuration wizard on 2021-10-19 at 10:49 PDT.
...
() {
  ...
  # Git status formatter from robyrussell theme
  function my_git_formatter2() {
    emulate -L zsh
  ...
  functions -M my_git_formatter2 2>/dev/null
